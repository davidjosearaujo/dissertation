...
1. The W-AGF registers the FN-CRG to 5GC as specified in [[3GPP TS 23.316 V18.6.0#7.2.1.3 FN-RG Registration via W-5GAN|clause 7.2.1.3]] or the 5G-CRG registers to 5GC as specified in [[3GPP TS 23.316 V18.6.0#7.2.1.1 5G-RG Registration via W-5GAN|clause 7.2.1.1]]
