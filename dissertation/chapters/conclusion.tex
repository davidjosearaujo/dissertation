...
\begin{itemize}
    ...
    \item \textbf{Performance Metrics:} %While iperf3 tests confirmed data plane connectivity and isolation, this validation did not focus on rigorous performance benchmarking (e.g., maximum throughput, detailed latency analysis under load, impact of the \ texttt{iptables} rules on the \ac{RG}-\ac{RG}'s performance). Such analysis would require a more specialized test setup.
