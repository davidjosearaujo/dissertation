...
\begin{lstlisting}[caption=\texttt{interceptor} \ac{MAC} address permited for \ac{IP} attribution,label={lst:interceptor_eap_success3}]
(...)
48| [DEBUG] 2025/05/31 14:43:28  MAC 08:00:27:b4:18:a9 added to /etc/dnsmasq.d/allowed-macs.conf.
(...)
\end{lstlisting}
