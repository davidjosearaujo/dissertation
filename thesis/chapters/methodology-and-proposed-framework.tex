...
% Clearly state the boundaries of your proposed framework and any underlying assumptions made during its design (e.g., assumptions about the capabilities of the Wi-Fi device or the trustworthiness of certain network elements).