...
As wireless networks evolve, the convergence of 5G with existing Wi-Fi infrastructures becomes increasingly critical. However, current standards established by the 3rd Generation Partnership Project (3GPP) do not adequately address the integration of Wi-Fi-only devices that lack Universal Subscriber Identity Module (USIM) capabilities into the 5G core network. This limitation is particularly evident in enterprise environments where many devices operate solely on Wi-Fi.
