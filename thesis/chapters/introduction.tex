...
Additionally, it is transforming private networks, which have traditionally relied on legacy wired or wireless (WLAN) Ethernet. Features like tighter security, higher reliability, and \ac{TSN} are critical for meeting Industry 4.0 requirements for wireless connectivity. But how can the industry bridge the gap between existing \ac{N5GC} devices, on which current nerwork rely devices and new \acp{5GC}?
