...
% image of SUPI, \ac{IMSI} and NAI structure
...
A Non-Authenticable Non-3GPP (NAUN3) device does not support \ac{NAS} signalling, is connected to 5GC via a RG and does not support authentication with the 5GC.%cite TS 23.316 3.1
